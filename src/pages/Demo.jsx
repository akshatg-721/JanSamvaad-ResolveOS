    ...
    <div className="min-h-screen" style={{ background: '#0A1628', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[white] mt-6">Try It Right Now</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 items-start">
          ...
          <div className="space-y-6">
            {steps.map(s => (
              <div key={s.num} className="flex gap-3 sm:gap-4 group">
          ...
          {/* Right: Call CTA */}
          <div className="rounded-3xl border border-[#FF9933]/20 bg-[#112240] p-4 sm:p-8 text-center">
            <p className="text-xs uppercase tracking-widest text-[#FF9933] mb-4">Call This Number</p>
            <p className="text-3xl sm:text-4xl font-bold text-[white] font-mono break-words">+1 (570) 630-8042</p>
            <div className="mt-6">
              <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=tel:+15706308042" alt="Call QR" className="mx-auto rounded-xl border border-white/10 w-full h-auto max-w-[180px]" width={180} height={180} />
            ...
            <a href="/dashboard" className="mt-6 inline-block w-full sm:w-auto px-8 py-3 min-h-10 rounded-xl bg-[#FF9933] text-black font-bold text-sm hover:bg-[#E6841C] transition-all">
              Open Live Dashboard →
            </a>
          </div>
        </div>
