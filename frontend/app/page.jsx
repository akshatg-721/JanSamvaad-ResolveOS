      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-xs text-[#8A9BB5]">
            ...
            <Link href="/track" className="hover:text-white transition-colors">Track Status</Link>
            <Link href="/public" className="hover:text-white transition-colors">Public Data</Link>
